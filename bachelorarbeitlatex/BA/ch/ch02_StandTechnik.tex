...
Die nachfolgende Abbildung \ref{fig_Solarturm} zeigt diesen 60 Meter hohen Turm \cite{XXX https://www.dlr.de/sf/desktopdefault.aspx/tabid-8560/15527_read-44867/}, inklusive der Spiegel, sog. \textit{Heliostaten}, die das Sonnenlicht in Richtung des Receivers fokussieren.
...
\begin{figure}[h!]
    ...
    \caption[Solarthermisches Demonstrations- und Versuchskraftwerk Jülich]{Solarthermisches Demonstrations- und Versuchskraftwerk Jülich \cite{XXX https://www.dlr.de/sf/Portaldata/73/Resources/images/Abt__STS/BeideSolartuerme_Luft_580x387.jpg}}
    \label{fig_Solarturm}
\end{figure}
...
Alternativ kann das erhitzte Medium auch in einem Energiespeicher zur späteren Verwendung zwischengespeichert werden. \cite{David MA Q10 ISBN 9783844002591}
...
\begin{figure}[h!]
    ...
    \caption[Vereinfachte schematische Darstellung eines Solarturmkraftwerkes]{Vereinfachte schematische Darstellung eines Solarturmkraftwerkes \cite{XXX Davids MA zitieren}}
...
Die Heliostaten bündeln die direkte Sonneneinstrahlung (siehe Kapitel XXX) auf den Receiver.
...
Dabei sind die beiden Freiheitsgrade der Heliostaten die Elevations- und die Azimut-Ebene, wie sie in Abbildung \ref{fig_FreiheitsgradeHeliostat} dargestellt sind. \cite{XXX Quelle 10 David MA}
...
\begin{figure}[h!]
    ...
    \caption[Darstellung der Elevations- und Azimut-Ebene]{Darstellung der Elevations- und Azimut-Ebene \cite{XXX Davids Masterarbeit}}
...
Weiterhin sind die Spiegel zumeist rechteckig angeordnet, eine Krümmung der Fläche nach innen, erzielt eine höhere Konzentration der Strahlung. \cite{XXX Quelle 10 David MA, Quelle 11 auch}.

Der tragende Körper der Heliostaten ist in der Regel aus wirtschaftlichen Gründen als T-Struktur vorgesehen \cite{Quelle 11 XXX}.
Die Heliostaten am Betrachtungsstandort Jülich bestehen aus lediglich einer ebenen, rechteckigen Facette auf einem T-Träger und sind mit einer Reflexionsfläche von $8.3m^2$ vergleichsweise klein \cite{XXX Gall Diss}.
Auf der \textit{PS10} (Planta Solar 10) bei Sevilla befinden sich beispielsweise Heliostaten mit $120m^2$ Reflexionsfläche in 28 Facetten \cite{XXX}. % https://www.researchgate.net/profile/Manuel-Silva-22/publication/257128243_PS10_CONSTRUCTION_OF_A_11MW_SOLAR_THERMAL_TOWER_PLANT_IN_SEVILLE_SPAIN/links/00b7d5245b98dac9eb000000/PS10-CONSTRUCTION-OF-A-11MW-SOLAR-THERMAL-TOWER-PLANT-IN-SEVILLE-SPAIN.pdf?origin=publication_detail
...
\begin{figure}[h!]
    ...
    \caption[Verschiedene Heliostatfeld-Layouts auf der Nordhalbkugel: Rundum-Feld und Nordfeld]{Verschiedene Heliostatfeld-Layouts auf der Nordhalbkugel: Rundum-Feld (links) und Nordfeld (rechts) \cite{XXX Quelle 10 MA}}
...
Erstere sind dann notwendig, wenn die Spiegel rund um den Solarturm angeordnet sind. Bei Nord- oder Südfeldern kommen rechteckige Receiver zum Einsatz, welche je nach Standort und Anwendungsfall auch nach innen gebogen sind, um vor Wärmeverlust durch zu schnelle Windgeschwindigkeiten an der Receiver Vorderseite zu schützen. \cite{XXX https://core.ac.uk/download/pdf/77230689.pdf}

Das Material des Receivers ist abhängig vom genutzten Wärmeträgermedium.
Typische Medien sind Luft, geschmolzene Salze, Wasser oder flüssige Metalle \cite{XXX Masterarbeit 16}; die Receiver bestehen in der Regel aus Metallröhren unterschiedlicher Legierungen für den Durchfluss von z.B. Salzschmelzen und Wasser oder aber aus poröser Keramik \cite{XXX Masterarbeit 17}\cite{https://www.osti.gov/pages/servlets/purl/1365805 XXX}.

Wenn Eigenschaften wie die maximal zulässigen thermischen Spannungen des Receivers überschritten werden, kann dieser beschädigt werden \cite{XXX MA 18}.
...
sowie der Windgeschwindigkeit zusammen \cite{XXX MA 19}.
...
Für Röhrenreceiver, die mit flüssigem Natrium gekühlt werden, sind beispielsweise maximale Strahlungsflussdichten von $2,5MW/m^2$ erlaubt, während bei luftgekühlten Röhrenreceivern nur $200kW/m^2$ \cite{XXX MA 10} erreicht werden dürfen.
...
\end{equation}
\centerline{\textbf{Formel \ref{eq_Strahlungsfluss}:} Berechnung des Strahlungsflusses $F$}
\myequations{\quad Berechnung des Strahlungsflusses $F$}

\begin{equation} \label{eq_Flussdichte}
    \phi = \frac{\text{d}F}{\text{d} A}
\end{equation}
\centerline{\textbf{Formel \ref{eq_Flussdichte}:} Berechnung der Flussdichte $\phi$}
...
\end{equation}
\centerline{\textbf{Formel \ref{eq_LeistungReceiver}:} Berechnung Bruttoleistung $P$ auf dem Receiver}
...
Der immense Einfluss der Kosinus-Verluste zeigt sich beispielsweise an Untersuchungen am Solar One Tower in Süd-Kalifornien, wo auch das Solarturmkraftwerk mit der höchsten Nennleistung beheimatet ist \cite{XXX https://solarpaces.nrel.gov/project/ivanpah-solar-electric-generating-system}.
Zwischen $0,65$ und $0,9$ schwankt der Kosinus-Wirkungsgrad jährlich in dieser Gegend, je nach Sonnenstand und damit verbundener Heliostaten Position. \cite{XXX MA 13}
...
\begin{figure}[h!]
    ...
    \caption[Seitenansicht eines Heliostaten zur Verdeutlichung des Winkels $\beta$ im Kontext der Kosinus-Verluste]{Seitenansicht eines Heliostaten zur Verdeutlichung des Winkels $\beta$ im Kontext der Kosinus-Verluste \cite{XXX Davids MA}}
    \label{fig_KosinusVerlust}
\end{figure}

Als schwerwiegender optischer Verlust durch die Heliostaten an sich sind die Reflexionsverluste zu nennen.
...
Reflektieren saubere Spiegeloberflächen normalerweise zwischen $87 \%$ und $94 \%$ des auf sie treffenden Sonnenlichts, sinkt dieser Wert durch umweltbedingte Verschmutzung auch schnell auf $80 \%$. \cite{XXX MA 10}
...
Durch ein geeignetes Felddesign kann diesen Verlusten entgegengewirkt werden. \cite{XXX MA 14}
...
\begin{figure}[h!]
    ...
    \caption[Blockierung und Abschattung von Heliostaten]{Blockierung (links) und Abschattung (rechts) von Heliostaten \cite{David MA XXX}}
    \label{fig_AbschattungBlockieren}
\end{figure}

Ein weiterer optischer Verlustfaktor sind die Spiegelfehler.
...
Die Größe des Fehlers wird als Winkel zwischen dem tatsächlichen Normalvektor des Spiegels und dem idealen Normalvektor gemessen und liegt in der Regel zwischen $0,08^\circ$ und $0,14^\circ$. \cite{XXX MA 10}
...
Dies geschieht beispielsweise auch durch die oben genannten Spiegelfehler oder wenn der Abstand zwischen Heliostat und Receiver so groß ist, dass das Abbild der Reflexion auf dem Receiver größer ist als der Receiver selbst. \cite{XXX MA 10}
...
Er kann Ursachen wie Schmutz oder Verschleiß an den Nachführachsen, oder Ungenauigkeiten bei der Motorausrichtung und Sonnenstandsmessung als Ursache haben \cite{XXX MA 15}. Auch dieser Fehler wird als Winkel gemessen und liegt normalerweise bei $0,03^\circ$ bis $0,1^\circ$ \cite{XXX MA 10}.

Für die Analyse des Systems wird nachfolgend mit vorberechneten Strahlungskarten aus dem in \cite{10 MA XXX} vorgestellten Programm \textit{STRAL} verwendet.
...
In der Praxis wird dies durch die sogenannten \textit{Nowcasting Systeme} erreicht, die in Ergänzung zu den klassischen Modellen der Wettervorhersage durch zeitlich und räumlich hochauflösende Beobachtungen genauere Vorhersagen liefern \cite{XXX https://www.dwd.de/DE/forschung/wettervorhersage/met_fachverfahren/nowcasting/nowcasting_node.html}.

Die sensorischen Möglichkeiten um solch präzise Vorhersagen generieren zu können sind sehr vielfältig.
Für deutschlandweit flächendeckende Vorhersagen nutzt der deutsche Wetterdienst beispielsweise Radarsysteme und Satellitenbilder \cite{XXX https://www.dwd.de/DE/forschung/wettervorhersage/met_fachverfahren/nowcasting/nowcast_mix_node.html UND https://www.dwd.de/DE/forschung/wettervorhersage/met_fachverfahren/nowcasting/cellmos_verfahren_node.html}.
...
Da die Auflösung der deutschlandweiten Vorhersage lediglich rund $1km$ x $1km$ beträgt \cite{https://www.dwd.de/DE/forschung/wettervorhersage/met_fachverfahren/nowcasting/konrad_node.html, UND https://www.dwd.de/DE/forschung/wettervorhersage/met_fachverfahren/nowcasting/cellmos_verfahren_node.html} während sich das Heliostatenfeld auf eine Fläche von rund $330m$ x $310m$ beschränkt, sind lediglich sehr grobe Vorhersagen zu erwarten.
Darüber hinaus ist auch die zeitliche Auflösung von 5 Minuten \cite{https://www.dwd.de/DE/forschung/wettervorhersage/met_fachverfahren/nowcasting/cellmos_verfahren_node.html XXX} unterhalb der Möglichkeiten anderer Nowcasting Systeme \cite{XXX https://www.dlr.de/sf/desktopdefault.aspx/tabid-10946/19311_read-44861/ AND https://www.sciencedirect.com/science/article/pii/S0038092X14000486?via%3Dihub}
}.
...
Der Prozess zur Erstellung von Nowcasting Vorhersagen auf Basis dieser Bilder wird beispielsweise in \cite{XXX in elib.
    dlr Paper sogar mit Seitenzahl angegeben https://www.sciencedirect.com/science/article/pii/S0038092X14000486?via%3Dihub}
} beschrieben. \cite{https://elib.dlr.de/188116/1/202208_SolarIrradianceNowcastingSystemTrialAndEvaluationForIslandMicrogridControlPurposes_Samu.pdf}

% https://elib.dlr.de/188116/1/202208_SolarIrradianceNowcastingSystemTrialAndEvaluationForIslandMicrogridControlPurposes_Samu.pdf
...
Räumlich gesehen können auf diese Weise Vorhersagen auf bis zu $20m$ x $20m$ getroffen werden. \cite{XXX https://elib.dlr.de/188116/1/202208_SolarIrradianceNowcastingSystemTrialAndEvaluationForIslandMicrogridControlPurposes_Samu.pdf UND https://www.dlr.de/sf/desktopdefault.aspx/tabid-10946/19311_read-44861/}
...
Aus diesen können anschlißend die in Abbildung \ref{fig_Nowcasting_Kamerabilder} rechts sichtbaren Wolkenmasken erstellt und damit die benötigten hochauflösenden Einstrahlungskarten berechnet werden. \cite{XXX https://www.dlr.de/sf/desktopdefault.aspx/tabid-10946/19311_read-44861/}
...
\begin{figure}[h!]
    ...
    \caption[Aufnahmen der ASIs auf der PSA  und die daraus extrahierten Wolknemaske]{Aufnahmen der ASIs auf der PSA (links) und die daraus extrahierten Wolknemasken (rechts) \cite{XXX https://www.dlr.de/sf/desktopdefault.aspx/tabid-10946/19311_read-44861/}}
...
Änderungen dieser Führungsgrößen soll möglichst genau gefolgt werden und unvorhersehbare Störungen sollen die Regelstrecke so wenig wie möglich beeinflussen. \cite{David MA 22 XXX} \\
...
Aus diesem Grund sind klassische Regler wie der PID Regler, die lediglich auf Basis der Abweichung von aktuellen Soll- und Istwerten Stellgrößen für das System vorgeben \ref[S. 408]{XXX Lunze Buch}, nicht ausreichend und es wird ein modellprädiktiver Regler (kurz \textit{MPC}) gewählt.

\subsection{Grundlagen} \label{subsec_GrundlagenMPC}
Neben der Möglichkeit zur Inbezugnahme von Vorhersagen ist ein großer Vorteil der MPC die Fähigkeit komplexe nicht-lineare \textit{MIMO}-Systeme (\textbf{M}ulti \textbf{I}nput \textbf{M}ulti \textbf{O}utput) zu regeln.
Der wohl bedeutendste Grund dafür, dass MPC in der Praxis mit dem PID-Regler den Stand der Technik ausmacht \cite[S. viii]{XXX Kouvaritakis}, ist jedoch die zusätzliche Möglichkeit Limitierungen auf Inputs und Outputs des Systems, sogenannte \textit{Constraints}, festlegen zu können; nachteilig ist jedoch der damit direkt verbundene, hohe Rechenaufwand. \cite[S. 1-2]{XXX Kouvaritakis}
...
Für die konkrete Anwendung würde der Solarturm die \gans{Plant} darstellen, in dieser Arbeit wird jedoch nur ein Modell dessen simuliert.
...
\begin{figure}[h!]
    ...
    \caption[Geschlossener Regelkreis mit einem MPC]{Geschlossener Regelkreis mit einem MPC gemäß\cite[S. 2]{XXX MPC Paper}}
...
Nach jedem Zeitschritt $T_s$ verschieben sich die Horizonte entsprechend, es wird eine neue Stellgröße an das System weitergegeben und die Optimierung wird erneut durchgeführt. \cite[S. 3]{XXX MPC Paper}
...
\begin{figure}[h!]
    ...
    \caption[Funktionsprinzip eines MPC]{Funktionsprinzip eines MPC nach \cite[S. 3]{XXX MPC Paper} gemäß} %\cite{XXX https://www.sciencedirect.com/science/article/abs/pii/0005109878900018?via%3Dihub}}
...
$p_{tv}$ für (zeitabhängige, \textbf{t}ime \textbf{v}arying) Modellparameter. \cite{XXX}% (vgl. \cite{XXX MPC Paper Seite 3 UND XXX https://www.do-mpc.com/en/latest/theory_orthogonal_collocation.html#secorthogonalpoly UND https://www.do-mpc.com/en/latest/getting_started.html})
...
\end{equation}
\centerline{\textbf{Formel \ref{eq_Modellbildung1} - \ref{eq_Modellbildung3}:} Diskretisierte mathematische Modelldarstellung}
...
In der Kostenfunktion sollte der Vergleich der zu regelnden Ausgangsvariablen mit der Referenztrajektorie über den Regelungshorizont in quadratischer Form abgebildet sein \cite[S.
    24]{XXX https://reader.elsevier.com/reader/sd/pii/S0959152419303592?token=9116B5F797959599B3BD2DBA2B22FBB70A5B3698AFC41837C28DE3FD61DB022DEB6C080BDDA6D75AFB434B863D095055&originRegion=eu-west-1&originCreation=20230402125017 UND Paper S. 3}.
...
Zuletzt ist es auch möglich einen Term in die Kostenfunktion einzubinden, welcher nicht über den gesamten Kontrollhorizont berechnet wird, sondern lediglich die abschließende Güte der Regelung bewertet \cite[S.
    24]{XXX https://reader.elsevier.com/reader/sd/pii/S0959152419303592?token=9116B5F797959599B3BD2DBA2B22FBB70A5B3698AFC41837C28DE3FD61DB022DEB6C080BDDA6D75AFB434B863D095055&originRegion=eu-west-1&originCreation=20230402125017}.
Ein mathematisches Beispiel einer solchen Kostenfunktion ist in Formel \ref{eq_Kostenfunktion} zu sehen, dabei stehen $W_1$, $W_2$ und $W_u$ für Gewichtungsfaktoren und $y(k+i\rvert k)$ für die zum Zeitpunkt $k$ bezüglich des Zeitpunktes $k+i$ vorhergesagte Ausgangsvariable. \cite[S. 3]{Paper XXX und https://www.do-mpc.com/en/latest/getting_started.html}
...
\end{equation}
\centerline{\textbf{Formel \ref{eq_Kostenfunktion}:} Beispielhafte Kostenfunktion für den MPC}
...
Ein zusätzlicher Freiheitsgrad wird durch die Einführung von soft constraints und sogenannten \textit{Slack Variablen} $\xi$ geschaffen. \cite[S. 4]{XXX Paper}
...
Dazu werden weitere Gewichtungsmatrizen nach \cite[S. 4]{Paper XXX}$W_w$ und $W_\xi$ in der Kostenfunktion eingefügt, letztere als trade-off zwischen Dauer und Höhe der constraint Überschreitung \cite{XXX in Paper steht 101 als Quelle}.
...
\begin{equation} \label{eq_Optimierungsproblem}
    \underset{u,\xi}{\text{min}} \quad (\ref{eq_Kostenfunktion})_{W_w} + \underbrace{\lVert_\xi(k+i\rvert k)\rVert_{W_\xi}}_{softening}
\end{equation}
...
subject to:
\vspace*{-\baselineskip}
$$u_{lb}\leq \left(u(k+j\rvert k)\right) \leq u_{ub},$$
$$y_{lb} - \left(\xi(k+i\rvert k)\right) \leq \left(y(k+j\rvert k)\right) \leq y_{ub} + \left(\xi(k+i\rvert k)\right),$$
$$\text{where } \xi \geq 0$$
$$\forall~i \in \left\{ N_1, ..., N_2-i \right\} \text{and } j \in \left\{0, ..., N_u\right\}$$
\enlargethispage*{\baselineskip}\centerline{\textbf{Formel \ref{eq_Optimierungsproblem}:} Beispielhaftes Optimierungsproblem für den MPC}
...
Das zugehörige Optimierungsproblem ergibt sich dann gemäß Gleichung \ref{eq_OptimierungZielpunkte}, wobei $T_{absorber,i}$ die jeweilige Temperatur am Cup $i$ darstellt und $(x_{z,h}, y_{z,h})$ the Zielpunktkoordinaten eines jeden Heliostaten $h$ darstellen. \cite{David MA XXX}

\begin{equation} \label{eq_OptimierungZielpunkte}
    \text{max} \quad P_{receiver}
\end{equation}
...
\end{align*}
\centerline{\textbf{Formel \ref{eq_OptimierungZielpunkte}:} Kontinuierliches Optimierungsproblem der Zielpunktregelung}
...
\end{align*}
\centerline{\textbf{Formel \ref{eq_OptimierungZielpunkteDiskret}:} Diskretes Optimierungsproblem der Zielpunktregelung}
...
Durch den Tracking-Error beispielsweise könnte die erlaubte Temperatur des Receivers verletzt überschritten werden, wenn die Verschiebung hin zu einem bereits kritisch heißen Cup geschieht. \cite{David MA XXX}
...
Eine präzise Übersicht über verschiedene Algorithmen zur Zielpunktregelung wurde von Oberkirsch in \cite{XXX Diss Oberkirsch} aufgestellt.
...
Maldonado \textit{et al.} \cite{XXX Diss Laurin 7 UND 202} entwickelte beispielsweise einen iterativen Algorithmus mit dem Namen \textit{Local Search}.
...
In einer Arbeit von Cruz \textit{et al.} \cite{Garcia Paper Quelle 3} wird ein Algorithmus zur Zielpunktsteuerung vorgeschlagen, der eine gewünschte Flussdichteverteilung auf dem Receiver erreichen soll.
...
Vant-Hull \textit{et al.} \cite{Diss Laurin 14 und 15} hat unter anderem das \textit{Dynamic Aimpoint Processing System} (\textit{DAPS}) entwickelt; eine Regelung die im Wesentlichen das Überschreiten maximaler Flussdichten verhindern soll.
...
García \textit{et al.} stellte einen Algorithmus vor, der das Problem nicht als \textit{MIMO} (\textbf{M}ulti \textbf{I}nput \textbf{M}ulti \textbf{O}utput) System definiert, also mit allen Heliostaten als Eingangsgrößen und allen Zielpunkten als separat zu berechnende Ausgangsgrößen, sondern als System aus 6 \textit{SISO} (\textbf{S}ingle \textbf{I}nput \textbf{S}ingle \textbf{O}utput) Subsystemen.
...
Die Einteilung des Systems in SISO-Subsysteme ist für stark gekoppelte Systeme mit großen Abhängigkeiten nicht sinnvoll. \cite[S. 33]{MA David XXX}


\subsection{Vorstellung des gewählten Algorithmus} \label{subsec_ZielpunktregelungGarcia}
Gewählt wird ein Algorithmus zur Zielpunktverteilung, welcher ebenfalls von Garcia \textit{et al.} \cite{XXX Paper Garcia} vorgestellt wurde und mit Gruppierung von Heliostaten und der oben angesprochenen \textit{dispersion} der Heliostaten arbeitet.
...
Abbildung \ref{fig_VerteilungHeliostateGarcia} zeigt diese Einteilung in 18x3 Gruppen von Heliostaten; die Gruppen sind farblich in Rot, Grün und Blau dargestellt. \cite[S. 8-10]{XXX Garcia Paper}
...
\begin{figure}[h!]
    ...
    \caption[Einteilung des Heliostatenfeldes des Gemasolar-Kraftwerkes in Sevilla in 54 Gruppen]{Einteilung des Heliostatenfeldes des Gemasolar-Kraftwerkes in Sevilla in 54 Gruppen \cite[S. 10]{XXX Garcia Paper}}
...
Einerseits den \textit{dispersion factor} $\kappa$, der Auskunft über die Streuung der Heliostaten innerhalb der Gruppe gibt und andererseits den Parameter $y_{cent}$, der die vertikale Position des \gans{Schwerpunktes} aller Zielpunkte auf dem Receiver beeinflussen kann \cite[S. 5]{XXX garcia Paper}.
...
\begin{figure}[h!]
    ...
    \caption[Symbolische Veranschaulichung der Stellgrößen des gewählten Algorithmus]{Symbolische Veranschaulichung der Stellgrößen des gewählten Algorithmus \cite[S. 7]{XXX Paper Garcia}}
...
\end{gather}
\centerline{\textbf{Formel \ref{eq_GarciaAlpha} und \ref{eq_GarciaDeltaAlpha}:} Berechnung des individuellen Heliostatenparameters $\alpha$}
...
\begin{center}
    \begin{varwidth}{0.95\textwidth}
        \textbf{Formel \ref{eq_GarciaMindestabstand}:} Bestimmung des Mindestabstandes eines jeden Zielpunktes zum nächstgelegenen Zielpunkt der Heliostatengruppe
    \end{varwidth}
\end{center}
...
\begin{figure}[h!]
    ...
    \caption[Minimalabstände der Zielpunkte je $\alpha$-Wert]{Minimalabstände der Zielpunkte je $\alpha$-Wert \cite[S. 9]{XXX Garcia Paper}}
...
Die Arbeit von García präsentiert außerdem die Berechnungsvorschrift, aus der hervorgeht, wie weit sich jeder einzelne der beiden Zielpunkte nun in jede Richtung bewegen muss \cite[S. 9-10]{XXX Garcia Paper}.
Um sicherzustellen, dass die Abstände eines jeden Zielpunktes zu allen anderen Zielpunkten der Gruppe eingehalten wird, wiederholen sich diese Berechnungsvorschriften für jedes mögliche Pärchen aus Heliostaten \cite[S. 9]{XXX Paper Garcia}.
Anschließend wird der Durchschnitt der berechneten Distanzen eines Zielpunktes relativ zu den anderen Heliostaten ($\Delta x_{TP_i}$) und ($\Delta y_{TP_i}$) errechnet \cite[S. 10]{XXX Paper Garcia}.
...
\end{equation}
\centerline{\textbf{Formel \ref{eq_GarciaGruppenzentrumbewegung}:} Erforderliche Schwerpunktverschiebung der Zielpunktgruppe}
\myequations{\quad Erforderliche Schwerpunktverschiebung der Zielpunktgruppe}

Darauf aufbauend ergeben sich mathematisch erneut die erforderlichen Verschiebungen der Gruppe $\Delta X_{Group}$ und $\Delta Y_{Group}$ nach \cite[S. 10]{XXX Garcia Paper}.
...
Die vollständige Darstellung des hier vorgestellten Algorithmus nach García \textit{et al.} \cite{XXX Paper Garcia} zeigt demnach Abbildung \ref{fig_GarciaAlg}.

\begin{figure}[h!]
    \centering
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=0.65\textwidth]{fig/GarciaAlgorithmus.png}}
    \caption[Übersicht der vollständigen Zielpunktstrategie nach García]{Übersicht der vollständigen Zielpunktstrategie nach García \cite[S. 10]{XXX Paper Garcia}}
    \label{fig_GarciaAlg}
\end{figure}
...
\begin{figure}[h!]
    ...
    \caption[Beispielhafte Zielpunktverteilungen für einen zunehmenden $\kappa$ Wert]{Beispielhafte Zielpunktverteilungen für einen zunehmenden $\kappa$ Wert \cite[S. 11]{XXX Paper Garcia}}
...
Dabei handelt es sich Stand März 2023 um die populärste Programmiersprache weltweit \cite{XXX https://de.statista.com/statistik/daten/studie/678732/umfrage/beliebteste-programmiersprachen-weltweit-laut-pypl-index/}.
Nicht zuletzt aufgrund der Echtzeitfähigkeit \cite[S. 9]{https://brochure.getpython.info/media/releases/psf-python-brochure-vol.-i-final-download.pdf/at_download/file XXX} und einfachen Syntax hat es sich besonders im Bereich des \textit{machine learning}s als Stand der Technik etabliert.
Darüber hinaus zeichnet sich Python durch seine große Anzahl an professionellen Frameworks und Bibliotheken aus, welche es Entwicklern ermöglichen, auch komplexe Probleme mit geringem Aufwand zu lösen \cite[S. 3]{https://brochure.getpython.info/media/releases/psf-python-brochure-vol.-i-final-download.pdf/at_download/file XXX}.
...
Durch CasADi soll besonders die dymbolische Formulierung von gewöhnlichen Differentialgleichungen (ODEs) und differential-algebraischen Gleichungen (DAEs) erleichtert und damit die Formulierung und Lösung nicht-linearer Programme und Regelungsprobleme ermöglicht werden. \cite{XXX Docs}
...
Ihre Modelle vereinen modular Simulations- Vorhersage- und Regelungskomponeten aus diesem Bereich. \cite{https://www.do-mpc.com/en/v4.1.1/ XXX}
