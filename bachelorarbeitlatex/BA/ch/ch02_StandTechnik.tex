...
Aus diesem Grund sind klassische Regler wie der PID Regler, die lediglich auf Basis der Abweichung von aktuellen Soll- und Istwerten Stellgrößen für das System vorgeben \ref[S. 408]{Lunze}, nicht ausreichend und es wird ein modellprädiktiver Regler (kurz \textit{MPC}) gewählt.
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.65\textwidth]{fig/AlgorithmusGarcia.pdf}}
