...
Die Konvergenz ist erreicht, wenn der Optimierungsfehler 10 Iterationen am Stück einen Wert von $\SI{5e-3}{}$ unterschreitet.
...
\fbox{\includegraphics[width=0.87\textwidth]{fig/cloud_sceanrio_clarification_modified.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.87\textwidth]{fig/windspeed_measurements.png}}
...
Als Referenzszenario wird ein sogenanntes \gans{Cloud Standby} Szenraio (nachfolgend CSS genannt) nach dem von Zavoico \cite[S.25ff]{Zavoico} vorgestellten Vorbild eingeführt, welches besonders für Receiver mit Salzschmelzen als Wärmeübertragungsmedium genutzt wird.
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.99\textwidth]{fig/no_control_shading_120sec_50_30mps.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.92\textwidth]{fig/no_control_RMSE.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=0.99\textwidth]{fig/all_info_shading_120sec_50_30mps.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=0.99\textwidth]{fig/all_info_RMSE.png}}
...
\begin{table}[ht!]
    ...
    \centering
    \begin{tabular}{>{\centering\arraybackslash}m{0.24\textwidth}>{\centering\arraybackslash}m{0.20\textwidth}>{\centering\arraybackslash}m{0.20\textwidth}>{\centering\arraybackslash}m{0.23\textwidth}}
        \rowcolor{white}
        \toprule
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=0.99\textwidth]{fig/no_info_shading_120sec_50_30mps.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=0.99\textwidth]{fig/no_info_RMSE.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=0.99\textwidth]{fig/safe_simulations_shading_25.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=0.99\textwidth]{fig/rmse_per_speed_shading_25.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=0.99\textwidth]{fig/safe_simulations_speed_30.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=0.99\textwidth]{fig/shading_120sec_75_30mps_thinking_50.png}}
...
\begin{figure}[t]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
    \fbox{\includegraphics[width=0.99\textwidth]{fig/rmse_per_shading.png}}
