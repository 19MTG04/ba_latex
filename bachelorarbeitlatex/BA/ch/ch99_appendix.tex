...
\fbox{\includegraphics[width=0.92\textwidth]{fig/no_control_shading_120sec_75_30mps.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.92\textwidth]{fig/all_info_shading_120sec_75_30mps.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.99\textwidth]{fig/no_control_shading_120sec_00_30mps.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.99\textwidth]{fig/all_info_shading_120sec_00_30mps.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.99\textwidth]{fig/no_info_shading_120sec_75_20mps.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.99\textwidth]{fig/all_info_shading_120sec_75_20mps.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.99\textwidth]{fig/no_info_shading_120sec_00_20mps.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.99\textwidth]{fig/all_info_shading_120sec_00_20mps.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.99\textwidth]{fig/no_control_shading_120sec_75_20mps.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.99\textwidth]{fig/no_control_shading_120sec_00_20mps.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.99\textwidth]{fig/safe_simulations_shading_0.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.99\textwidth]{fig/safe_simulations_shading_50.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.99\textwidth]{fig/safe_simulations_shading_75.png}}
...
\setlength{\fboxsep}{1pt}
\setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.99\textwidth]{fig/rmse_per_speed_shading_0.png}}
...
\setlength{\fboxsep}{1pt}
\setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.89\textwidth]{fig/rmse_per_speed_shading_50.png}}
...
\begin{figure}[h!]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.89\textwidth]{fig/rmse_per_speed_shading_75.png}}
...
\begin{figure}[t]
    ...
    \setlength{\fboxsep}{1pt}
    \setlength{\fboxrule}{1pt}
\fbox{\includegraphics[width=0.99\textwidth]{fig/shading_120sec_75_30mps_thinking_00.png}}
